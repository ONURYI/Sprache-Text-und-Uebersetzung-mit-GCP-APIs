...
Automatisierte Spracherkennung (ASR), auch unter dem Begriff maschinelles Transkribieren oder Sprache-zu-Text bekannt, nutzt Methoden des maschinellen Lernens, um gesprochene Audioinhalte in Text umzuwandeln. 
