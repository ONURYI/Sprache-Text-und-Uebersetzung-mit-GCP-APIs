...
\begin{enumerate}
	\item Der Entwickler sendet eine API-Anfrage von seiner Anwendung aus. Diese Anfrage enthält die erforderlichen Parameter und den API-Schlüssel. Ein Beispiel für eine solche Anfrage könnte folgendermaßen aussehen:
	...
	\item Die Google Cloud API sendet eine Antwort zurück an die Anwendung des Entwicklers. Diese Antwort enthält die Daten oder das Ergebnis, das der Entwickler angefordert hat. Eine typische Antwort könnte folgendermaßen aussehen:
