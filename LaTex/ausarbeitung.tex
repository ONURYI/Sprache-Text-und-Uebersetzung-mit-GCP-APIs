...
\begin{document}
		...
		\begin{titlepage}
			\begin{center}
				\vspace*{1cm}
				\Huge
				Sprache, Sprachverarbeitung, Text \& Übersetzung mit Google Cloud APIs
...
\textit{}\end{center}
\  \\ 
Zum Vergleich, schauen wir uns nun einmal das von OpenAI bereitgestellte ASR Modell, namens \textbf{\textit{Whisper AI}}(siehe \cite{radford2023robust}) an, welche mithilfe des Paketverwalters pip von Python installiert werden:
...
\end{verbatim}
\ \\
Wir sind auch hier das die Sprache richtig transkripiert wird, jedoch die \textit{confidence}.
