...
\\ \\ 
Im folgenden Python-Codeausschnitt sehen wir, wie wir die Credentials aus der JSON-Datei laden und die Google Speech-to-Text API aufrufen, auch auf unserer eigenen Entwicklungsumgebung verwenden können. Es handelt sich um die selbe FLAC-Audiodatei \footnote{Auf   \url{https://github.com/ONURYI/Sprache-Text-und-Uebersetzung-mit-GCP-APIs} abrufbar}, welche wir laden und rufen die \textbf{recognize}-Funktion auf, um die Spracherkennung durchzuführen.
\ \\
