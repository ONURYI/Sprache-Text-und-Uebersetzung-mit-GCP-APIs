...
In diesem Abschnitt wird nun die Erkennung und Übersetzung von Texten behandelt. Hierbei wird auf die Möglichkeiten der C\textit{loud Translation API} von Google Cloud eingegangen \cite{cloudtranslation2023}.
