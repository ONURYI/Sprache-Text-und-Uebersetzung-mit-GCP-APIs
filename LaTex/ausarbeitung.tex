...
Automatisierte Spracherkennung (ASR), auch unter dem Begriff maschinelles Transkribieren oder Sprache-zu-Text bekannt, nutzt Methoden des maschinellen Lernens, um gesprochene Audioinhalte in Text umzuwandeln. Die Anwendungsfälle sind vielfältig und gehen von Untertiteln über virtuelle Assistenten bis hin zu interaktiven Sprachsystemen.
\\ \\
...
\\ \\
Am Ende dieses Prozesses präsentiert das ASR-System den transkribierten Text als Endergebnis. 
\\ \\
